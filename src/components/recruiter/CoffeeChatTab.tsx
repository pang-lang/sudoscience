    ...
    <div id="recruiter-coffee-chat-tab" className="space-y-6 max-w-7xl mx-auto w-full">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 p-6 md:p-8 shadow-sm">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <span className="text-[10px] text-amber-500 font-mono uppercase tracking-widest font-semibold block">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-6 pt-5 border-t border-slate-100">
          ...
          <div className="bg-slate-900 rounded-2xl p-4 flex items-start gap-3 border border-slate-800">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="text-[10px] text-amber-400 font-mono truncate">{managerProfile.dept}</p>
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4">
            <div className="flex justify-between items-center mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-black font-mono text-amber-600 bg-amber-50 px-2 py-0.5 rounded border border-amber-200">
                  {matchThreshold}/100
                </span>
              </div>
            </div>
        ...
        {subTab === 'matches' && (
          <div className="mt-4 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs focus:outline-none focus:border-amber-400"
            />
          </div>
        )}
      </div>
                      ...
                      <div className="p-5 flex-1 flex flex-col gap-3">
                        ...
                        {cand.matchedOn.length > 0 && (
                          <div className="bg-amber-50 border border-amber-100 rounded-xl p-2.5 flex items-start gap-2">
                            ...
                            <div>
                              <span className="text-[9px] font-mono text-amber-600 uppercase tracking-wider font-bold block mb-0.5">
                                Why they match you
                              </span>
                              <div className="flex flex-wrap gap-1">
                                {cand.matchedOn.map((term, i) => (
                                  <span key={i} className="text-[9px] bg-white border border-amber-200 text-amber-800 font-bold px-1.5 py-0.5 rounded-full">
                                    {term}
                                  </span>
                                ))}
                              </div>
                        ...
                        <div className="mt-auto pt-3 border-t border-slate-100 flex items-center gap-2">
                          ...
                          {!invite ? (
                            <button
                              ...
                              className="flex-1 py-2 text-[10px] font-bold bg-amber-500 hover:bg-amber-600 text-white rounded-xl transition cursor-pointer flex items-center justify-center gap-1 shadow shadow-amber-400/30"
                            >
