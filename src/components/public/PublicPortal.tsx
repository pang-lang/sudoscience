                ...
                <form onSubmit={handleRequestSubmit} className="space-y-6">
                  ...
                  <div className="flex justify-between items-center gap-4 border-t border-slate-100 pt-6">
                    ...
                    <button
                      ...
                      className={`px-6 py-2.5 font-bold text-xs rounded-xl shadow-sm hover:shadow transition flex items-center gap-1.5 cursor-pointer text-white border-0 ${
                        eduSubmitted ? 'bg-slate-400' : 'bg-emerald-600 hover:bg-emerald-700'
                      }`}
                    >
